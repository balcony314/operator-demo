...
import (
	...
	"github.com/balcony314/operator-demo/internal/controller"
	webhookv1 "github.com/balcony314/operator-demo/internal/webhook/v1"
...
func init() {
	...
	utilruntime.Must(memoryv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "6798199d.example.com",
	...
	// 创建 metrics clientset，用于读取 PodMetrics（Metrics API）
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err := webhookv1.SetupMemoryPolicyWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "Failed to create webhook", "webhook", "MemoryPolicy")
			os.Exit(1)
		}
	}
